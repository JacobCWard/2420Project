...
public class bstFrame extends JFrame {
	...
	public bstFrame() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] { "Month...",
		...
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] { "Day...",
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				Account account = main.getAccount(ssn); //NullPointerException here.... Not sure why.
				txtYear.setText(account.getByear()+"");
			}
		});
